...
public class KindsOfVariable {
    ...
    * */
    ...
    /* static field를 정적필드(클래스 변수)라고 한다. 클래스 영역에 생성되는 변수라는 의미이다. */
    private static int staticNum;

    public void testMethod(int num) {   //메소드 영역의 시작

        /* 메소드의 괄호안에 선언하는 변수를 매개변수라고 한다.
        * 메소드 영역에서 작성되는 변수를 지역변수라고 한다.
        * 매개변수도 일종의 지역변수로 생각하면 된다.
        * */
        int localNum;

        System.out.println(num);    //매개변수는 호출 시 값이 넘어와서 변경되기 때문에 초기화가 필요없다.
//        System.out.println(localNum); //지역변수는 선언외에 다시 사용(호출)하기 위해서는 반드시 초기화가 되어야 한다.
