...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("st1 == str2 : " + (str1 == str2));  //true
        System.out.println("st2 == str3 : " + (str2 == str3));  //false
        System.out.println("st3 == str4 : " + (str3 == str4));  //false

        System.out.println("st3 == str4 : " + (str3.equals(str4))); //true
        ...
        System.out.println("str4의 hashCode : " + str4.hashCode());  //3254818
        ...
        * */
        ...
        /* equals() : String 클래스의 클래스의 equals() 메소드는 인스턴스 비교가 아닌 문자열값을 비교하여
        * 동일한 값을 가지는 경우 true, 다른 값을 가지는 경우 false를 반환 하도록
