...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        Animal a1 = new Cat(); //Animal은 사용자 정의 타입
        Animal a2 = new Tiger();
...
//        Tiger t = new Animal();
        ...
        /*
        * [ 동적바인딩]
        * 컴파일 당시에는 (선언한) 해당타입의 메소드와 연결되어 있다가
...
//        a2.bite();
        ...
        * 타입 형변환 시 실제 인스턴스와 타입이 일치하지 않는경우 ClassCastException이 발생할 수 있다.
        * */
...
//        ((Tiger)a1).bite();     //고양이는 호랑이가 될 수 없다.
        ...
        /* 래퍼런스변수가 참조하는 실제 인스턴스가 원하는 타입과 맞는지 비교하는 연산자 instanceof */
        ...
        * */
        ...
        Cat cat1 = (Cat)animal1;        //down-casting (수동)명시적 형변환
//        Cat cat2 = animal2;             //down-casting (자동)묵시적 형변환 안됨
