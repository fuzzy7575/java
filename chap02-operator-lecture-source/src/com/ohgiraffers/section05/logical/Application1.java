...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 논리 연산자의 종류
         * 1. 논리 연결 연산자 : 두개의 피연산자를 가지는 이항 연산자이며, 두개의 논리식을 판단하여 참과 거짓을 판단한다.
         *   1-1. &&(논리 AND) 연산자 : 두개의 논리식중 모두 참 일 경우 참을 반환, 하나라도 거짓인 경우 거짓을 반환
         *   1-2. ||(논리 OR) 연산자 : 두개의 논리식중 하나라도 참 일 경우 참을 반환, 둘 다 거짓일 경우 거짓 반환
        ...
        System.out.println("a > b보다 && c < d : " + (a > b && c < d));                 //false
        System.out.println("a > b보다 && c > d : " + (a > b && c > d));                 //false

        System.out.println("a < b || c < d : " + (a < b || c < d));                    //true
        System.out.println("a < b || c > d : " + (a < b || c > d));                    //true
        System.out.println("a > b || c < d : " + (a > b || c < d));                    //true
        System.out.println("a > b || c > d : " + (a > b || c > d));                    //fslse
    }
}
