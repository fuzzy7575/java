...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         *
         * [메소드 재정의(overriding)]
         * 부모가 가지는 메소드 선언부(header)를 그대로 사용하면서
         * 자식클래스가 정의한 메소드대로 동작하도록 메소드 구현부(body) 부분을 새롭게 다시 작성하는 기술이다.
         ...
         *
         * [상속의 단점]
         * 1. 부모클래스의 기능을 추가/ 변경할 경우 자식 클래스가 정상 동작하는지 예측이 힘들다.
         *   상속 구조가 복잡해질수록 그 영향에 대한 예측이 힘들며 이런 단점이 유지보수성이 증가한다는 장점과 반대로
         *   유지보수에 악영향을 준다.
         * 2. 부모클래스의 변경 또한 쉽지 않다.
         *   자식 클래스에서 중요하게 사용하는 기능인 경우, 부모클래스 변경 시 자식클래스에 모두 영향을 줄 수 있다.
