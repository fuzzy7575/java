...
public class Application3 {
    public static void main(String[] args) {
        ...
        /* 필기. 변수의 명명 규칙
        * 변수의 이름을 지를 때 아무렇게나 짓는 것이 아닌 정해진 규칙이 있다.
        * 실무적으로 굉장히 중요하기 때문에 반드시 숙지해야 하고,
        * 또한, 규칙에 맞는 올바른 변수명으 짓는것이 좋은 프로그래밍을 하는 첫 단추이다.
        */
        ...
        *   2-6. 전형적인 변수 이름이 있다면 가급적 긍정형태로 네이밍 한다.
        */
...
//        int for = 20;   //예약어 사용 불가
        ...
        int True = 10;   //예약어 true와 다른것으로 취급한다.


        int sadfbkfjbskjbnfglsgnslregnslkglsgsgmsg;
        ...
        boolean isAlive = true;   //부정형보다는 긍정형이 나은형식
