...
//        iarr1 = new int[][];   //크기를 지정하지 않아 에러 발생
        iarr2 = new int[3][];
//        iarr3 = new int[][3];   //주소를 묶어서 관리할 배열으 크기를 지정하지 않으면 에러
        iarr3 = new int[3][];
        ...
        * 정변 배열 : 서로 같은 길이의 배열 여러 개를 하나로 묶어 관리하는 2차원 배열
