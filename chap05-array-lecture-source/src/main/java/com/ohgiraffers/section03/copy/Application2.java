...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("원본 hashCode : " + originArr.hashCode());
        System.out.println();
